...
class DoubleQFunc(nn.Module):
    ...
    def __init__(self, state_dim, action_dim, num_hidden_layers, hidden_size):
        ...
        self.network1 = MLPNetwork(state_dim + action_dim, 1, num_hidden_layers, hidden_size)
        self.network2 = MLPNetwork(state_dim + action_dim, 1, num_hidden_layers, hidden_size)
...
class SAC_Agent:
    ...
    def __init__(self, state_dim, action_dim, seed=100, lr=3e-4, gamma=0.99, tau=5e-3, batchsize=256, hidden_size=256, update_interval=1, num_actor_layers=2, num_critic_layers=2, replay_capacity=1e6):
        ...
        self.replay_pool = ReplayPool(capacity=int(replay_capacity))
    ...
    def optimize(self, n_updates, state_filter=None):
        ...
        print(f"Training details: \n{n_updates} updates\n{len(self.replay_pool)} replay pool size\n{self.batchsize} batch size")
